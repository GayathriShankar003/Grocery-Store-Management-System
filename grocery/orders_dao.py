...
def get_order_details(connection, order_id):
    ...
    query = "SELECT order_details.order_id, order_details.quantity, order_details.total_price, " \
            "products_table.name, products_table.price_per_unit FROM order_details LEFT JOIN products_table on " \
            "order_details.product_id = products_table.product_id where order_details.order_id = %s"
